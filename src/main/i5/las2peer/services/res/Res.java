...
public class Res extends RESTService {
  ...
  @Api
  @SwaggerDefinition(
      info = @Info(title = "10003", version = "",
          description = "",
          termsOfService = "",
          contact = @Contact(name = "", email = "CAEAddress@gmail.com") ,
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-10003/blob/master/LICENSE.txt") ) )
  @Path("/")
  ...
  public Response getSongs() {
    ...
    if(res_condition) {
      ...
      return Response.status(HttpURLConnection.HTTP_OK).entity("Test2").build();
    }
    return null;
  }
